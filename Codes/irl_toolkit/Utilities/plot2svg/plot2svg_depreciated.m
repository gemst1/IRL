...
%  24-01-2010 - Bugfix nomy line #619 (thanks to Pooya Jannaty)

global PLOT2SVG_globals
global colorname
progversion='24-Jan-2010';
...
for i=length(axchild):-1:1
    ...
    elseif strcmp(get(axchild(i),'Type'),'image')
        ...
        if ndims(pointc) == 3
            ...
            if PLOT2SVG_globals.octave
				imwrite(pointc,cmap,fullfile(PLOT2SVG_globals.basefilepath,filename));

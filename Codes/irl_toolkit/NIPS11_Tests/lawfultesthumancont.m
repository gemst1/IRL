...
for i=1:NUM_SEEDS,
    load(['Human_Demos/highway_lawful_demo_seed_' num2str(INIT_SEED+i-1) '_length_64.mat']);
...
mdp_params = {struct('length',64,'num_cars',[34 6],'policy_type','lawful','continuous',1,'determinism',0.7,'seed',INIT_SEED)};
...
% Save.
saveresults('Lawful_Human_Cont',test_params,test_metric_names,test_model_names,...

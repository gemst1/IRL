...
mdp_params = {struct('length',64,'num_cars',[34 6],'policy_type','lawful','continuous',1,'determinism',0.7,'seed',0)};
...
% Save.
saveresults('Lawful_Auto_Cont',test_params,test_metric_names,test_model_names,...
